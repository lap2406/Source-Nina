        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    ...
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['company']) && $config['newsletter'][$type]['company'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="company">Tên công ty:</label>
                            <input type="text" class="form-control" name="data[company]" id="company" placeholder="Tên công ty" value="<?=@$item['company']?>">
                        </div>
                    <?php } ?>
