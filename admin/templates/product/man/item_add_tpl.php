			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['product'][$type]['giasi']) && $config['product'][$type]['giasi'] == true) { ?>
						<div class="form-group col-md-4">
							<label class="d-block" for="giasi">Giá sỉ:</label>
							<div class="input-group">
								<input type="text" class="form-control format-price gia_si" name="data[giasi]" id="giasi" placeholder="Giá sỉ" value="<?=@$item['giasi']?>">
								<div class="input-group-append">
									<div class="input-group-text"><strong>VNĐ</strong></div>
								</div>
							</div>
