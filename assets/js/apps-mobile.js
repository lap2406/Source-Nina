...
NN_FRAMEWORK.FixedMenu = function() {
    ...
    $(window).bind('scroll', function() {
        if ($(window).scrollTop() > height) {
            $('.wrap-top').addClass('fixed transition');
            // $('.wrap-top').addClass('d-none');
        } else {
            $('.wrap-top').removeClass('fixed transition');
            // $('.wrap-top').removeClass('d-none');
        }
    });
};
/* SlickSlide */
...
NN_FRAMEWORK.LoadMore = () => {
        if ($(".container-loadMoreList").exists()) {
            $(".container-loadMoreList .loadMoreList-list").each(function() {
                ...
                $.ajax({
                    url: "ajax/ajax_productlistmobile.php?idl=" + idl + "&page=" + page + "&first=" + first + "&load=" + load + "&table=" + table + "&type=" + type + "&thumb=" + thumb,
                    type: "GET",
                    success: function(result) {
            ...
            $('.container-loadMoreList .loadMoreList-btn').click(function() {
                ...
                $.ajax({
                    url: "ajax/ajax_productlistmobile.php?idl=" + idl + "&page=" + page + "&first=" + first + "&load=" + load + "&table=" + table + "&type=" + type + "&thumb=" + thumb + "&com=" + com,
                    type: "GET",
                    success: function(result) {
