...
define("dichvunoibatcuachungtoi","Dịch vụ nổi bật của chúng tôi");
define("nhantinp","NHẬP THÔNG TIN CỦA BẠN ĐỂ NHẬN CHƯƠNG TRÌNH KHUYẾN MÃI CỦA CHÚNG TÔI");
define("tencuaban","Tên của bạn");
define("email","Email");
define("congtycuaban","Công ty của bạn");
define("vuilongnhapcongtycuaban","Vui lòng nhập tên công ty của bạn");
define("hinhanhhoatdong","Hình ảnh hoạt động");
define("ykienkhachhang","Ý kiến khách hàng");
define("doitac","Đối tác");
define("liehengay","Liên hệ ngay");
