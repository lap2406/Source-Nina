<?php
	...
	if(!empty($_POST['thanhtoan']))
	{
	    ...
	    $hoten = (!empty($_POST['ten'])) ? htmlspecialchars($_POST['ten']) : '';
	    $email = (!empty($_POST['email'])) ? htmlspecialchars($_POST['email']) : '';
	    $dienthoai = (!empty($_POST['dienthoai'])) ? htmlspecialchars($_POST['dienthoai']) : '';
	    ...
	    $httt = (!empty($_POST['payments'])) ? htmlspecialchars($_POST['payments']) : 0;
	    $htttText = ($httt) ? $func->get_payments($httt) : '';
	    $yeucaukhac = (!empty($_POST['yeucaukhac'])) ? htmlspecialchars($_POST['yeucaukhac']) : '';
		$tamtinh = (!empty($_POST['price-temp'])) ? htmlspecialchars($_POST['price-temp']) : 0;
